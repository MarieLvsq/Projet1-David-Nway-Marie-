...
public class Stagiaire2 implements Comparable<Stagiaire> {
	...
	public Stagiaire2(String nom, String prenom, String departement, String promo, String annee) {
		this.nom = nom;
		this.prenom = prenom;
	...
	public static boolean contains(Stagiaire2 nouveauStagiaire) {
		// TODO Auto-generated method stub
		return false;
	}

	public static void add(Stagiaire2 nouveauStagiaire) {
		// TODO Auto-generated method stub
		
	}

	public static Window getBoundsInParent(){
		// TODO Auto-generated method stub
